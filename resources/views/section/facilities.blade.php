...
<section class="max-w-[1400px] mx-auto flex flex-col items-center text-center py-16 px-6 bg-white">
    ...
    <div class="mb-12">
        ...
        <p class="font-raleway text-lg text-gray-600 mt-2">
            We offer modern (5-star) hotel facilities for your comfort.
        </p>
    </div>

    {{-- Section Cards (8 items in grid) --}}
    <div class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-8 w-full max-w-7xl">
        ...
        <div
            ...
            <h3
                class="font-poppins text-xl font-semibold text-[#7C6A46] group-hover:text-white transition-all duration-300">
                Swimming Pool
            </h3>
        </div>
